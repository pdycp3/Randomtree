...
public:
	...
	*response: the predict result
	**************************************************/
	void predict_feature(float*sample, float*response);
	/************************************************
	...
	*responses: the predict results
	***********************************************/
	void predictvec(float**testset, int SampleNum, float**responses);
	/************************************************
	*path: the path to save the model
	*************************************************/
	void saveModel(const char*path,const char * leafnode, float ** traindata);
	/************************************************
