...
{
	Result* arg1 = (Result*)a;
	Result* arg2 = (Result*)b;
	if (arg1->prob < arg2->prob) return -1;
	else if (arg1->prob == arg2->prob) return 0;
	else return 1;
}
/***************************************************************/
//ClasNode
...
void ClasNode::createLeafWithId()
{
	_class = 0;
	_prob = _probs[0];
	for (int i = 1; i < _samples->getClassNum(); ++i)
...
void RegrNode::createLeafWithId()
{
}
